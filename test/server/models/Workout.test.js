...
describe('Workout Model Method Tests:', () => {
  ...
  const workoutTwo = {
    uid: '5edd746c6aad0f5c0asdas018f',
    name: 'Workout Two',
    date: new Date(),
    training: [
      {
  ...
  describe('saveWorkout', () => {
    it('saves a new Workout to the Workouts collection', async () => {
      // set up
      // exercise
    ...
    it('does not save a new Workout if the UID does not exists', async () => {
      const response = await Workout.saveWorkout(workoutTwo);
