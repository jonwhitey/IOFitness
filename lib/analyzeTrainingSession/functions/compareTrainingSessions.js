...
export const compareTrainingSessions = (lastCompletedSession, completedSession) => {
  ...
  const newLastCompletedExercises = change_IdToString(lastCompletedExercises);

  console.log(typeof completedExercises[12]._id);
  console.log(completedExercises[12]._id);
  console.log(typeof lastCompletedExercises[12]._id);
  console.log(newLastCompletedExercises[12]._id);
  console.log('BELOW SHOULDBE STRING');
  console.log(typeof newLastCompletedExercises[12]._id);
  console.log(newLastCompletedExercises);
  const exercisesToProgress = completedExercises.filter((exercise) =>
    newLastCompletedExercises.some((exercise2) => {
